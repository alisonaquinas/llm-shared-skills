...
1. Confirm the implementation still matches the role contract.
2. Confirm all required files and helpers are present.
3. Confirm defaults and optional handoff inputs are documented.
