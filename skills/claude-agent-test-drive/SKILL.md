---
name: claude-agent-test-drive
description: >
  Test Drive phase for delegated agent workflow development. Use when planning, designing, building,
...
- `references/scenario-matrix.md` — Load when designing live agent delegation scenarios and friction review
...
| Variant | PARTIAL | Missing ownership example | Add example |
| Recovery | FAIL | Escalation policy unclear | Tighten docs |
```
