---
name: claude-agent-sdlc
description: >
  Orchestrate the full end-to-end SDLC for delegated agent workflow development. Use when building
  a new delegated agent workflow from scratch, following a complete development pipeline, managing
