...
2. Keep the user-facing orchestration description independent of a single runtime.
3. Document runtime-only features as implementation notes, not universal requirements.
4. Identify the minimum delegation capability needed from another runtime.
5. Prefer conceptual parity over forced 1:1 feature matching.
6. Record what stays identical across platforms: roles, outputs, and safety rules.
7. Record what may differ: delegation syntax, registration, or coordination surfaces.
