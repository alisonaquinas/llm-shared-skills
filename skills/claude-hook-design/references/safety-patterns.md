...
Use this reference when the rule can block actions, rewrite files, or trigger risky follow-on behavior.
...
10. Revisit this checklist whenever the rule gains new write or approval powers.
